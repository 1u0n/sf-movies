        ...
        1: [function(require, module, exports) {
            ...
            var AutoComplete = (function() {
                ...
                AutoComplete.prototype.event = function(params, type, event) {
                    ...
                    for (var name in AutoComplete.prototype.getEventsByType(params, type)) {
                        var mapping = AutoComplete.merge({
                            ...
                            match = ConditionOperator.AND == mapping.Operator;
                ...
                AutoComplete.prototype.makeRequest = function(params, callback, callbackErr) {
                    ...
                    var inputValue = params.Input.value;

                    console.log(params._HttpMethod() + " " + inputValue);

                    var propertyHttpHeaders = Object.getOwnPropertyNames(params.HttpHeaders),
                        request = new XMLHttpRequest(),
                        method = params._HttpMethod(),
                        url = params._Url(),
                        queryParams = params._Pre(),
                        queryParamsStringify = encodeURIComponent(params._QueryArg()) + "=" + encodeURIComponent(queryParams);
                    ...
                    request.onreadystatechange = function() {
                        if (request.readyState == 4 && request.status == 200) {
                            params.$Cache[inputValue.toLowerCase()] = request.response;
                    ...
                    if (params.RequestTimeout) {
                        request.ontimeout = function() {
                            console.log("TIMED OUT, RETRY: " + this.retries);
                ...
                AutoComplete.prototype.ajax = function(params, request, timeout) {
                    ...
                    if (timeout === true) {
                        ...
                        console.log("LAUNCHING A " + (request.timeout ? "REQUEST WITH TIMEOUT" : "REQUEST WITHOUT TIMEOUT"));
                        params.Request.send(params._QueryArg() + "=" + params._Pre());
                    }
                };
                AutoComplete.prototype.cache = function(params, callback, callbackErr) {
                    var response = params._Cache(params.Input.value.toLowerCase());
